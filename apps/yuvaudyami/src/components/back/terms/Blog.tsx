      ...
      <Section>
        <div className="flex flex-col space-y-4">
          ...
          <div className="text-justify text-primary flex flex-col space-y-4">
            <p>Welcome to Yuva udyami swarojgar!</p>
            <p>
              These terms and conditions outline the rules and regulations for the use of Yuva
              udyami swarojgar. Website, located at https://www.Yuvaudyamiswarojgar.org/.
            </p>
            <p>
              By accessing this website we assume you accept these terms and conditions. Do not
              continue to use Yuva udyami swarojgar if you do not agree to take all of the terms and
            ...
            <p>
              ...
              Ourselves We Our and Us refers to our Company. or Us refers to both the Client and
          ...
          <div className="text-justify text-primary flex flex-col space-y-4">
            <p className="font-bold text-2xl text-dark">Cookies</p>
            <p>
              We employ the use of cookies. By accessing Yuva udyami swarojgar, you agreed to use
              cookies in agreement with the Yuva udyami swarojgar Privacy Policy.
            </p>
            <p>
          ...
          <div className="text-justify text-primary flex flex-col space-y-4">
            <p className="text-xl md:text-3xl font-bold text-dark">License</p>
            <p>
              Unless otherwise stated, Yuva udyami swarojgar and/or its licensors own the
              intellectual property rights for all material on Yuva udyami swarojgar. All
              intellectual property rights are reserved. You may access this from Yuva udyami
              swarojgar for your own personal use subjected to restrictions set in these terms and
              conditions.
            </p>
            <p className="">You must not:</p>
            <ul className="flex flex-col gap-2 px-4">
              <li>1. Republish material from Yuva udyami swarojgarl</li>
              <li>2. Sell, rent or sub-license material from Yuva udyami swarojgar</li>
              <li>3. Reproduce, duplicate or copy material from Yuva udyami swarojgar</li>
              <li>4. Redistribute content from Yuva udyami swarojgar</li>
            </ul>
          </div>
          ...
          <div className="text-justify text-primary flex flex-col space-y-4">
            ...
            <p>
              ...
              information in certain areas of the website. Yuva udyami swarojgar does not filter,
              edit, publish or review Comments prior to their presence on the website. Comments do
              not reflect the views and opinions of Yuva udyami swarojgar,its agents and/or
              affiliates. Comments reflect the views and opinions of the person who post their views
              and opinions. To the extent permitted by applicable laws, Yuva udyami swarojgar shall
            ...
            <p>
              Yuva udyami swarojgar reserves the right to monitor all Comments and to remove any
              Comments which can be considered inappropriate, offensive or causes breach of these
              Terms and Conditions.
            </p>
            <p className="">You warrant and represent that:</p>
            <ul className="flex flex-col gap-2 px-4">
              <li>
              ...
              <li>
                2. The Comments do not invade any intellectual property right, including without
            ...
            <p>
              You hereby grantYuva udyami swarojgar a non-exclusive license to use, reproduce, edit
          ...
          <div className="text-justify text-primary flex flex-col space-y-4">
            <p className="text-xl md:text-3xl font-bold text-dark">Hyperlinking to our Content</p>
            <p>
              The following organizations may link to our Website without prior written approval:
            </p>
            <ul className="flex flex-col gap-2 px-4">
              <li>1. Government agencies;</li>
              <li>2. News organizations;</li>
              <li>3. Search engines;</li>
              <li>
                4. Online directory distributors may link to our Website in the same manner as they
                hyperlink to the Websites of other listed businesses; and
              </li>
              <li>
                5. System wide Accredited Businesses except soliciting non-profit organizations,
            ...
            <ul className="flex flex-col gap-2 px-4">
              ...
              <li>5. educational institutions and trade associations.</li>
            </ul>
            <p>
              ...
              from the visibility of the hyperlink compensates the absence of Yuva udyami swarojgar;
            ...
            <p>
              ...
              linking to our website, you must inform us by sending an e-mail to Yuva udyami
              swarojgar. Please include your name, your organization name, contact information as
            ...
            <ul className="flex flex-col gap-2 px-4">
              ...
              <li>
                3.By use of any other description of our Website being linked to that makes sense
                within the context and format of content on the linking party’s site.
              </li>
            </ul>
            <p>
              No use of Yuva udyami swarojgar logo or other artwork will be allowed for linking
              absent a trademark license agreement.
            </p>
          </div>

          <div className="text-justify text-primary flex flex-col space-y-4">
            <p className="text-xl md:text-3xl font-bold text-dark">iFrames</p>
            <p>
          ...
          <div className="text-justify text-primary flex flex-col space-y-4">
            <p className="text-xl md:text-3xl font-bold text-dark">Content Liability</p>
            <p>
          ...
          <div className="text-justify text-primary flex flex-col space-y-4">
            <p className="text-xl md:text-3xl font-bold text-dark">Your Privacy</p>
            <p>Please read Privacy Policy</p>
          </div>

          <div className="text-justify text-primary flex flex-col space-y-4">
            <p className="text-xl md:text-3xl font-bold text-dark">Reservation of Rights</p>
            <p>
          ...
          <div className="text-justify text-primary flex flex-col space-y-4">
            <p className="text-xl md:text-3xl font-bold text-dark">Disclaimer</p>
            <p>
            ...
            <ul className="flex flex-col gap-2 px-4">
              ...
              <li>
                4. exclude any of our or your liabilities that may not be excluded under applicable
                law.
              </li>
            </ul>
            <p>
