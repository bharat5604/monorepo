  ...
  return (
    <div className=" py-10">
      <Section>
        <div className="">
          <div>
            <p className="text-center  py-2 text-light">Last updated: December 26, 2022</p>
          </div>
          <div className="flex flex-col space-y-4 ">

            <div className="flex flex-col text-justify space-y-2 text-primary">
              <p>
                At Yuva udyami swarojgar, accessible from https://www.Yuva udyami swarojgar.org/,
                one of our main priorities is the privacy of our visitors. This Privacy Policy
                document contains types of information that is collected and recorded by Yuva udyami
                swarojgar and how we use it.
              </p>
              <p>
              ...
              <p>
                ...
                Yuva udyami swarojgar. This policy is not applicable to any information collected
                offline or via channels other than this website. Our Privacy Policy was created with
                the help of the Free Privacy Policy Generato
              </p>
            </div>

            <div className="flex flex-col space-y-2 text-justify text-primary">
              <p className="text-xl md:text-3xl font-semibold text-dark">Consonent.</p>
              <p>
            ...
            <div className="flex flex-col text-justify space-y-2 text-primary">
              <p className="text-xl md:text-3xl font-bold text-dark">Information we collect</p>
              <p>
            ...
            <div className="flex flex-col text-justify space-y-2 text-primary">
              <p className="text-xl md:text-3xl font-bold text-dark">How we use your information</p>
            ...
            <div className="flex flex-col space-y-2 text-justify text-primary">
              <p className="text-xl md:text-3xl font-semibold text-dark">Log Files.</p>
              <p>
                Yuva udyami swarojgar follows a standard procedure of using log files. These files
            ...
            <div className="flex flex-col space-y-2 text-justify text-primary">
              <p className="text-xl md:text-3xl font-semibold text-dark">Cookies and Web Beacons</p>
              <p>
                Like any other website, Yuva udyami swarojgar uses cookies. These cookies are used
                to store information including visitors preferences, and the pages on the website
            ...
            <div className="flex flex-col space-y-2 text-justify text-primary">
              <p className="text-xl md:text-3xl font-semibold text-dark">
                Advertising Partners Privacy Policies
              </p>
              <p>
                You may consult this list to find the Privacy Policy for each of the advertising
                partners of Yuva udyami swarojgar.
              </p>
              <p>
                ...
                on Yuva udyami swarojgar, which are sent directly to users browser. They
                automatically receive your IP address when this occurs. These technologies are used
                to measure the effectiveness of their advertising campaigns and/or to personalize
                the advertising content that you see on websites that you visit.
              </p>
              <p>
                Note that Yuva udyami swarojgar has no access to or control over these cookies that
            ...
            <div className="flex flex-col space-y-2 text-justify text-primary">
              ...
              <p>
                Yuva udyami swarojgar Privacy Policy does not apply to other advertisers or
            ...
            <div className="flex flex-col space-y-2 text-justify text-primary">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <p>
                  Request that a business that collects a consumers personal data disclose the
                ...
                <p>
                  Request that a business that sells a consumers personal data, not sell the
            ...
            <div className="flex flex-col space-y-2 text-justify text-primary">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <p>
                  he right to erasure – You have the right to request that we erase your personal
            ...
            <div className="flex flex-col space-y-2 text-justify text-primary">
              <p className="text-xl md:text-3xl font-semibold text-dark">Children,s Information</p>
              <p>
              ...
              <p>
                Yuva udyami swarojgar does not knowingly collect any Personal Identifiable
